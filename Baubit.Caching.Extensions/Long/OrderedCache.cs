...
{
    /// <summary>
    /// Thread-safe ordered cache with long identifiers and generic value types.
    /// This type provides backward compatibility by specializing <see cref="OrderedCache{TId, TValue}"/> with long as the identifier type.
    /// </summary>
    /// <typeparam name="TValue">The type of values stored in cache entries.</typeparam>
    /// <remarks>
    /// <para>
    /// OrderedCache provides time-ordered storage using monotonically increasing long identifiers,
    ...
    /// and time-series buffering where sequential integer IDs are preferred. Do not use for generic key/value 
    /// caching or TTL-based caching.
    /// </para>
    /// </remarks>
